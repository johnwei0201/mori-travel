...
export const attractions = {
  ...
  'mt-fuji': {
    ...
    intro:
      '富士山不是走近才好看,而是要退遠一點。河口湖、山中湖、忍野八海這幾個經典觀景點,把山體、湖面倒影與四季植被一次收進同一個畫面裡。冬天空氣乾冷,是一年中山頭最清楚的季節;春天有櫻花前景,秋天則是紅葉環繞。真正登頂只在七、八月開放,多數旅人來這裡是為了看它,而不是爬它。從東京新宿搭高速巴士到河口湖約兩小時,是最省事的方式;若想一次走完幾個觀景點,租車會自由許多。山頂全年有將近一半的日子被雲遮住,想拍到完整山形,清晨的機率遠高於午後。住一晚湖畔旅館、把日出那一段留給自己,通常比當天來回值得。',
    points: [
  ...
  kyoto: {
    ...
    intro:
      '京都的魅力不在單一景點,而在整座城市保留下來的尺度感——低矮的町屋、窄窄的石板巷、隨處可見的神社鳥居。清水寺、伏見稻荷、嵐山竹林是必訪的三個代表,但真正讓人記得的往往是走錯路時撞見的某條小巷。建議至少留兩天,一天走東山、一天走嵐山與金閣寺一帶。市區移動以公車為主,但尖峰時段容易塞,短程走路或騎單車反而更快。賞櫻與紅葉是全年最擠的兩段時間,清水寺、伏見稻荷若能在早上八點前抵達,會是完全不同的體驗。住宿建議選在四条或京都車站一帶,往東山與嵐山都方便。',
    points: [
  ...
  hokkaido: {
    ...
    intro:
      '北海道的面積接近台灣的兩倍半,一次玩不完是正常的。夏天的富良野是薰衣草與彩虹花田,秋天有大雪山的紅葉,冬天則是札幌雪祭、小樽運河的雪景與二世谷的粉雪。因為景點之間距離遠,自駕或包車幾乎是必要的,行程也建議以「一個區域待久一點」為原則,而不是每天換城市。新千歲機場是主要入口,從札幌到富良野、美瑛約兩小時車程,往函館則建議搭特急列車。冬季路面結冰,不熟悉雪地駕駛的話,包車或鐵路加當地巴士會安全得多。道東的知床與釧路濕原人少景大,適合已經來過一次、想走得更深的旅人。',
    points: [
  ...
  osaka: {
    ...
    intro:
      '如果京都是安靜的,大阪就是吵鬧而好客的那一面。道頓堀的巨大招牌、心齋橋的購物人潮、新世界的串炸老店,構成這座城市最直接的印象。大阪城的天守閣與周邊公園提供了另一種節奏,春天更是市內最好的賞櫻地之一。它也是關西的交通樞紐,適合當作京都、奈良、神戶的住宿基地。關西機場到市區搭南海電鐵約四十分鐘,市內則以地鐵御堂筋線串起主要區域。想吃得道地,黑門市場與鶴橋一帶比觀光大街更值得走一趟。以大阪為基地,前往奈良、神戶都在一小時內,姬路城也只要一小時多。',
    points: [
  ...
  gyeongbokgung: {
    ...
    intro:
      '景福宮是朝鮮王朝的正宮,也是首爾最完整的宮殿建築群。從光化門進入後,勤政殿、慶會樓一路展開,背景是北岳山的稜線,建築與山勢的關係是它最好看的地方。穿韓服可以免票入場,因此宮內經常能看到成群的韓服身影——這已經成為景福宮體驗的一部分,而不只是觀光噱頭。每天固定時段有守門將交接儀式,是拍照的重點時刻,建議先查當日場次。週二休館,排行程時要特別留意。宮殿北側是青瓦台與三清洞,東側接著北村韓屋村與仁寺洞,一整天的動線可以完全用走的串起來。',
    points: [
  ...
  gamcheon: {
    ...
    intro:
      '甘川洞原本是戰後難民聚落,層層疊疊的房子沿山坡而建。1990 年代後由藝術家與居民共同改造,牆面刷上彩色油漆、巷弄裡藏進壁畫與裝置藝術,成了釜山最具代表性的文化village。這裡仍是有人居住的社區,走訪時的音量與拍照分寸,是這個景點特別需要注意的部分。從釜山地鐵土城站轉搭小巴上山,班次密集但車小易滿,假日要有排隊的心理準備。村內全是斜坡與階梯,鞋子舒適比什麼都重要。入口可以買一份蓋章地圖,沿途在指定店家集章,是把巷弄走完整的好方法。',
    points: [
  ...
  jeju: {
    ...
    intro:
      '濟州是火山噴發形成的島嶼,漢拏山立在中央,海岸線則遍布黑色玄武岩。城山日出峰的火山口、萬丈窟的熔岩洞穴都是世界自然遺產。春天的油菜花與櫻花同時盛開,是島上最漂亮的季節。整座島環一圈約 200 公里,租車兩三天就能玩得相當完整。從首爾金浦機場飛濟州約一小時,是韓國國內最繁忙的航線。島上公車可達主要景點,但班距長,租車仍是最有效率的選擇。天氣變化快,同一天可能山上起霧、海邊放晴,行程排鬆一點比較不會被打亂。想更深入可以走一段偶來小路,二十多條路線沿著海岸串起整座島。',
    points: [
  ...
  nami: {
    ...
    intro:
      '南怡島是漢江上的一座半月形小島,因《冬季戀歌》而廣為人知。島上最著名的是那條筆直的水杉步道,春綠、夏蔭、秋黃、冬雪,一年四季完全不同。島不大,租腳踏車繞一圈約一小時,也可以純步行慢慢走。多數人會與小法國村、晨靜樹木園排在同一天。從首爾搭 ITX 青春列車到加平約一小時,再轉接駁車到渡船口;除了渡輪,也可以搭高空飛索直接滑進島內。水杉大道秋天最美也最擠,想拍到沒有人的畫面得趕第一班船。冬天下雪時人潮反而少,雪景配上筆直的樹列,是另一種安靜的漂亮。',
    points: [
  ...
  bangkok: {
    ...
    intro:
      '曼谷把極端的兩面放在同一座城市裡:大皇宮與臥佛寺的金碧輝煌,和考山路、恰圖恰週末市集的喧鬧市井。昭披耶河貫穿其中,搭交通船遊河是避開塞車又能看見城市樣貌的方式。這裡的按摩、街邊小吃與購物商場價格都相對友善,是東南亞行程中最容易安排的一站。市區塞車嚴重,空鐵 BTS 與地鐵 MRT 幾乎是必要的移動方式,河岸一帶則搭交通船最快。進入大皇宮與寺廟需要包覆肩膀與膝蓋,穿短褲背心會被擋在門外。三、四月是最熱的季節,建議把室內景點排在正午,傍晚再出門走市集。',
    points: [
  ...
  bali: {
    ...
    intro:
      '峇里島的分區很清楚:烏布在山裡,是梯田、瑜伽與手工藝;水明漾與庫塔在海邊,是衝浪與夕陽;努沙杜瓦則以度假村為主。多數人會安排前半段住烏布、後半段移到海邊,一趟旅程同時擁有山與海。島上寺廟眾多,宗教仍深深嵌在日常生活裡,清晨常能看到門口的祭品小盤。島上沒有大眾運輸,包車一日遊是最普遍的方式,價格相對親民。烏布到海邊約一小時多,尖峰時段可能翻倍,轉點那天別排太滿。海邊區域的浪況差異大,庫塔適合初學衝浪,想單純游泳則選努沙杜瓦。雨季落在十一月到三月,多半是午後短暫的大雨,不至於毀掉整天。',
    points: [
  ...
  'halong-bay': {
    ...
    intro:
      '下龍灣是聯合國世界自然遺產,一千九百多座石灰岩島嶼散布在海面上,晨霧未散時像水墨畫。最好的體驗方式是搭乘過夜遊船——白天划獨木舟穿過岩洞、參觀水上人家,傍晚在甲板看日落,隔天清晨的海面通常最平靜。當天來回雖然可行,但幾乎只能看到最外圍的部分。從河內出發車程約兩個半小時,高速公路通車後比以往快上許多。過夜遊船的品質差異極大,船齡、艙房與航線都要看清楚,便宜的船通常只在近岸繞行。十月到四月天氣較乾爽;夏季陽光雖好,但颱風可能導致停航。想避開人潮,鄰近的蘭下灣是另一個選擇。',
    points: [
  ...
  phuket: {
    ...
    intro:
      '普吉島是泰國最大的島,西岸一整排海灘各有個性:芭東熱鬧、卡塔卡倫適合家庭、奈漢則安靜許多。真正的重頭戲通常在跳島——皮皮島、蛋島、甲米的攀牙灣都能當天往返。島上還保留了葡萄牙殖民風格的普吉老鎮,彩色街屋與咖啡館適合安排半天避開烈日。島上以計程車與嘟嘟車為主,價格需要先議定;住宿分散的話,租機車會方便許多。十一月到四月是乾季,海況穩定、適合跳島;五月到十月的雨季浪大,部分離島航線會停駛。皮皮島當天往返通常很趕,時間允許的話在島上住一晚會從容得多。',
    points: [
  ...
  'eiffel-tower': {
    ...
    intro:
      '鐵塔是 1889 年萬國博覽會的臨時建築,原訂二十年後拆除,卻因為無線電天線的用途保留下來,最後成了巴黎最不可取代的輪廓。登塔分三層,第二層的視野其實最好——能清楚看見塞納河的彎道與街區紋理;頂層則勝在高度。若不打算登塔,夏佑宮平台與戰神廣場是兩個最經典的拍攝點。門票建議提前線上預約,旺季現場排隊可能超過一小時。入夜後每個整點會有五分鐘閃燈,最後一場在午夜前後,是最多人等待的時刻。不打算登塔也沒關係——夏佑宮平台野餐、或沿塞納河走到亞歷山大三世橋,都是不必花錢的好安排。',
    points: [
  ...
  colosseum: {
    ...
    intro:
      '競技場建於西元 80 年,是古羅馬帝國最具代表性的建築。今天看到的殘缺外牆並非戰爭所致,而是中世紀被當成採石場拆走了大量石材。門票通常與古羅馬廣場、帕拉丁丘綁在一起,三個景點相連,是理解羅馬城市起源最完整的一條路線。地下層與競技場地面層需另外預約導覽。門票採時段制且經常售罄,務必提前在官網預約,現場購票的隊伍通常很長。夏季正午石地反射的熱度驚人,清晨開門或傍晚閉館前兩小時最舒服。步行十分鐘可到真理之口與威尼斯廣場,再往北接萬神殿與許願池,是羅馬最經典的一條步行路線。',
    points: [
  ...
  santorini: {
    ...
    intro:
      '聖托里尼其實是一座火山島的殘骸——三千多年前的大噴發把島中央炸成海灣,剩下的懸崖邊緣就是今天伊亞與費拉小鎮的所在。房子刷成白色是為了反射陽光,藍色圓頂則多半是教堂。伊亞的日落名聞遐邇,但要有心理準備:那是全島最擁擠的一小時。島上以巴士與租車為主;伊亞到費拉的步道全長約十公里,沿著火山口稜線走,是最好的健行路線。住宿分懸崖區與海灘區,前者景觀好但價格高、階梯多,後者實惠卻看不到火山口。想避開日落人潮,可以改在伊亞城堡以外的餐廳露台,或搭傍晚的帆船從海上看。',
    points: [
  ...
  jungfraujoch: {
    ...
    intro:
      '少女峰車站海拔 3,454 公尺,被稱為「歐洲屋脊」,是全歐洲最高的火車站。列車從茵特拉肯出發,經過格林德瓦或勞特布龍嫩,最後一段鑽進艾格峰山體內部,是百年前的工程奇蹟。山頂終年積雪,設有觀景台、冰宮與通往阿萊奇冰河的雪地步道——那是阿爾卑斯山最長的冰河。車票是瑞士交通中相對昂貴的一段,持瑞士旅行通行證可享折扣,建議先比較再買。山頂天氣變化極快,出發前先看官網的即時影像,雲霧太厚上去會什麼都看不到。想省一點又要有高山景觀,菲斯特或雪朗峰是常見的替代方案。',
    points: [
  ...
  'statue-of-liberty': {
    ...
    intro:
      '自由女神像是 1886 年法國贈送給美國的獨立百年賀禮,雕像內部的鋼骨結構由建造艾菲爾鐵塔的艾菲爾設計。對當年搭船抵達的移民來說,她是新生活的第一個畫面。今天從砲台公園搭渡輪上自由島,可以繞行雕像一圈,行程通常會一併停靠愛利斯島——那裡是移民檢查站舊址,現在改為博物館。上島的渡輪票包含自由島與愛利斯島,基座與皇冠需另外預約,皇冠名額極少且常提前數月售罄。只想看外觀的話,免費的史泰登島渡輪會從雕像旁經過,是不花錢的選項。夏季日照長,建議一早出發,把整個上午留給兩座島。',
    points: [
  ...
  'grand-canyon': {
    ...
    intro:
      '大峽谷長 446 公里、最深處超過 1,800 公尺,裸露的岩層記錄了將近二十億年的地質史。南緣全年開放、設施完整,是九成遊客的選擇;北緣海拔更高、冬季封閉,但人少而幽靜。真正震撼的時刻通常在日出與日落——側光讓岩層的層次與顏色全部浮現出來,正午反而最平淡。從拉斯維加斯開車到南緣約四個半小時;只有一天的話,直升機或小飛機行程會比自駕實際。園區內住宿需要很早預訂,替代方案是住在圖薩揚或威廉斯。步道一旦往下走,回程全是上坡,體力與水量要留足——夏季谷底溫度可能超過四十度。',
    points: [
  ...
  banff: {
    ...
    intro:
      '班夫是加拿大第一座國家公園。露易絲湖與夢蓮湖那種近乎螢光的藍綠色,來自冰河磨蝕岩石產生的極細粉末懸浮在水中,陽光下才會顯色——所以陰天去,顏色會差很多。冰原大道連接班夫與傑士伯,沿途 230 公里幾乎每個轉彎都是風景,是北美公認最美的公路之一。從卡加利機場開車約一個半小時。夢蓮湖的道路只在六月到十月開放,且已全面禁止自駕進入,必須搭接駁車或預約接送。七、八月是旺季,住宿與停車位都要提前處理。九月下旬的落葉松轉黃、與冬季的冰泡湖,是避開人潮的另外兩個時機。',
    points: [
  ...
  'las-vegas': {
    ...
    intro:
      '拉斯維加斯大道(The Strip)不到七公里,卻塞進了世界上最密集的大型度假村。威尼斯人的運河、貝拉吉歐的音樂噴泉、凱薩宮的羅馬廊柱,把各地地標搬進沙漠複製一遍——這種不加掩飾的人造感,正是這座城市的性格。它同時也是前往大峽谷、羚羊彩穴與錫安國家公園最方便的起點。大道上的度假村看起來很近,實際一棟走到一棟常要十五分鐘以上,善用飯店之間的電車與空橋。貝拉吉歐噴泉、幻境火山等表演都是免費的,光靠散步就能排滿一晚。要延伸行程的話,羚羊彩穴與馬蹄灣約四個半小時車程,通常與大峽谷排在同一趟。',
    points: [
  ...
  'sydney-opera-house': {
    ...
    intro:
      '歌劇院由丹麥建築師約恩・烏松設計,1973 年落成,前後蓋了十四年,預算超支十四倍。那組白色殼狀屋頂其實由超過一百萬片瑞典製磁磚拼成,近看會發現有兩種光澤。它同時是仍在使用中的表演場館,一年上演超過一千八百場演出——如果時間允許,買一場音樂會的票是最好的參觀方式。官方有中文導覽場次,可以進到平常不開放的排練廳與後台。最好的外觀拍攝點其實不在歌劇院本身,而是對岸的便利朗角與岩石區,黃昏時港灣大橋與白帆會同時入鏡。前往曼利與塔隆加動物園的渡輪都從旁邊的環形碼頭出發,適合接著安排半天。',
    points: [
  ...
  'great-barrier-reef': {
    ...
    intro:
      '大堡礁由近三千座獨立珊瑚礁組成,是地球上最大的活體結構,也是唯一從太空能辨識的生物構造。從凱恩斯出海約兩小時可抵達外礁平台,浮潛就能看到硬珊瑚、熱帶魚與海龜;想更深入則可選擇體驗潛水。近年白化問題受到關注,選擇有生態認證的船公司,是對這片海比較負責的做法。凱恩斯與道格拉斯港是兩個主要出海點,後者離外礁略近、人也少一些。外海航程長,容易暈船的人建議提前服藥,或選擇有大型平台的船班。六月到十月海況較穩、能見度好;十一月到五月是水母季,下水需要穿防護衣。',
    points: [
  ...
  queenstown: {
    ...
    intro:
      '皇后鎮坐落在瓦卡蒂普湖畔,背後是被稱為「卓越山脈」的鋸齒狀山稜。世界第一座商業高空彈跳點就在附近的卡瓦勞大橋,此後噴射快艇、滑翔傘、跳傘陸續在此發展,讓這裡成了公認的極限運動之都。不玩極限也沒關係——搭天空纜車上山看湖景,或往米佛峽灣、格林諾奇走,同樣值得。從基督城開車約六小時,但沿途的普卡基湖與庫克山值得慢慢走,許多人會安排兩天。鎮中心步行可達,住宿價格偏高,預算有限可以考慮附近的箭鎮或法蘭克頓。米佛峽灣當天往返車程加船程約十三小時,能在蒂阿瑙住一晚會輕鬆很多。',
    points: [
  ...
  melbourne: {
    ...
    intro:
      '墨爾本的精華不在大馬路上,而在那些被稱為 laneway 的小巷裡——塗鴉、獨立咖啡館與小酒吧藏在其中,構成這座城市的日常。它是澳洲的咖啡之都,精品咖啡文化從這裡擴散到全世界。往城外走,大洋路的十二使徒岩與菲利普島的企鵝歸巢,是兩條最經典的一日遊路線。市中心有免費電車區,環城路線幾乎涵蓋主要景點,是認識街廓最省事的方式。咖啡館多半早上開、下午三四點就收,想體驗當地節奏得早起。這裡以「一天有四季」聞名,即使夏天也建議帶件外套。大洋路自駕建議安排兩天,當天來回會有大半時間耗在車上。',
    points: [
  ...
  jiufen: {
    ...
    intro:
      '九份因日治時期的金礦而興起,礦業沒落後一度沉寂,直到電影《悲情城市》讓它重新被看見。整座聚落依山而建,基山街、豎崎路兩條主要動線串起茶樓、小吃與紀念品店。真正的看點在於高度——從觀景平台望出去,山勢一路傾斜到基隆嶼與太平洋,傍晚燈籠亮起、海面還留著餘光的那十幾分鐘最美。從台北車站搭火車到瑞芳再轉公車,或從忠孝復興站搭客運直達,車程都約一小時。假日午後人最多,想拍到空一點的豎崎路,建議一早或平日前往。附近的金瓜石黃金博物園區,與十分、菁桐的平溪線,都能與九份排在同一天。',
    points: [
  ...
  yehliu: {
    ...
    intro:
      '野柳是一道伸入海中的岬角,由砂岩構成。海蝕、風化與地殼運動長期作用,造出蕈狀岩、燭台石、薑石等罕見地貌。最有名的女王頭因為頸部持續變細,已被列為需要保護的對象,近年僅能在圍欄外遠觀合影。園區規劃了三區步道,由入口往岬角尖端走,岩層形態會愈來愈奇特。從台北搭客運約一個多小時,或由捷運淡水站轉公車沿北海岸前往。女王頭前排隊合影常要等上二三十分鐘,開園後的第一小時人最少。岬角上幾乎沒有遮蔭,夏天務必準備帽子與水;東北季風強勁時,部分區域會拉起警戒線。',
    points: [
  ...
  yangmingshan: {
    ...
    intro:
      '陽明山國家公園距離台北市中心只要半小時,卻是完整的火山地形——小油坑的噴氣孔、硫磺谷的地熱,都還在活動中。二、三月的櫻花與海芋,五月的繡球花,十月的擎天崗芒草,四季各有主題。想輕鬆一點可以走花鐘、竹子湖一帶;想挑戰則有七星山主峰步道,是台北市的最高點。從捷運劍潭站搭紅 5 公車可直達;花季期間山上停車不易,搭大眾運輸會省去很多麻煩。二、三月的花季會實施交通管制,出發前先查當年的日期與路線。山上氣溫比市區低好幾度,冬天記得加件外套。下山順路可以在北投或行義路泡個溫泉,把一天收尾。',
    points: [
  ...
  tamsui: {
    ...
    intro:
      '漁人碼頭原本是淡水河口的小漁港,改建後成了台北近郊最容易抵達的看海地點。跨港的情人橋是單塔斜張橋,入夜後打上變換的燈光。這裡的日落之所以出名,是因為河口開闊、西面無遮擋,太陽會直接沉進海平線。從淡水老街搭渡輪過來只要十分鐘,兩個景點通常會排在同一個下午。捷運淡水站轉公車約二十分鐘,或從淡水老街搭渡輪十分鐘直達,搭船那段本身就是風景。日落時間隨季節變化很大,夏天約六點半、冬天五點多,出發前查一下比較不會撲空。碼頭旁有情人塔可以俯瞰河口,腹地內也有商場與餐廳,天氣不好時仍有地方待。',
    points: [
  ...
  taroko: {
    ...
    intro:
      '太魯閣峽谷是立霧溪長期下切大理岩層形成的,兩側岩壁近乎垂直,最窄處只容得下一條溪與一條路。中橫公路沿著峽谷開鑿,本身就是一段艱鉅的工程史。燕子口、九曲洞是最能感受峽谷尺度的兩段步道;長春祠與白楊步道則各有瀑布景觀。園區步道常因落石或颱風封閉,出發前務必先查詢開放狀況。從花蓮市區開車約四十分鐘,或搭台灣好行太魯閣線;園區腹地大,沒有交通工具會很受限。部分路段規定必須配戴安全帽,入口處可以免費借用。近年受地震影響,多條步道長期封閉或分段開放,行程務必以國家公園官網的最新公告為準,不要照著舊資訊排。',
    points: [
  ...
  'qingshui-cliff': {
    ...
    intro:
      '清水斷崖是清水山東側直接落入太平洋的岩壁,落差超過八百公尺,是台灣最具代表性的海岸地形之一。蘇花公路沿著崖壁開闢,匯德觀景台與崇德步道是兩個能安全停車、完整看見崖線的位置。海水因為深度變化呈現層次分明的藍,上午順光時顏色最飽和。近年也可以選擇搭獨木舟或 SUP 從海上仰望崖壁。蘇花公路沿線可停車的點不多,匯德與崇德是最主要的兩處,其餘路段路肩狹窄,不要隨意停靠。大型車輛多、彎道又急,自駕時要特別留意。從花蓮市區出發約四十分鐘,通常會與太魯閣排在同一天。海上獨木舟行程多在清晨出發,受風浪影響大,常要前一天才確定成行。',
    points: [
  ...
  qixingtan: {
    ...
    intro:
      '七星潭其實不是潭,而是一道長達二十多公里的新月形海灣。海灘由大小不一的礫石構成,浪打上來再退回時會發出獨特的沙沙聲。因為地形陡降,離岸幾公尺水深就急遽增加——這也是這裡嚴禁戲水的原因。天氣好時可以看見清水斷崖的稜線,清晨則是花蓮看日出最方便的地點。從花蓮車站開車約十五分鐘,是花蓮市區最容易抵達的海岸。這裡的浪有明顯的暗流與瞬間拉扯力,岸邊立有多面警示牌,務必保持距離、不要背對海浪。清晨看日出、傍晚看月牙灣的弧線,是兩個最舒服的時段。沿自行車道往北可以接到四八高地,視野更開闊。',
    points: [
  ...
  jiaoxi: {
    ...
    intro:
      '礁溪的溫泉屬碳酸氫鈉泉,無色無味、酸鹼度接近中性,泡後皮膚會有滑順感,俗稱美人湯。它罕見地湧出在平原而非山區,因此整座市鎮就建在泉源之上,從車站走幾分鐘就能找到湯屋。除了付費湯屋,市區也有免費的足湯公園。冬天泡湯配上宜蘭的濕冷空氣,是最舒服的季節組合。從台北轉運站搭客運約五十分鐘,或搭火車到礁溪站,出站步行就能找到湯屋,是北部最方便的溫泉區。湯屋分大眾池與個人池,價差不小,先確認是否需要自備盥洗用品。附近的湯圍溝公園有免費足湯,適合等車時消磨。順路可以接五峰旗瀑布或林美石磐步道,走一段再回來泡湯。',
    points: [
  ...
  'sun-moon-lake': {
    ...
    intro:
      '日月潭的名字來自它的形狀——北側圓如日、南側彎如月,中間隔著拉魯島。環湖公路約三十公里,自行車道更被評為世界最美的路線之一。清晨常起霧,水面與遠山之間會浮出一層白,是攝影者最想捕捉的時刻。搭遊船可在水社、玄光寺、伊達邵三個碼頭間往返,伊達邵一帶保留了邵族的文化與市集。從台中高鐵站搭客運約一個半小時。環湖除了開車,也可以搭遊湖巴士或租電輔自行車,後者不必擔心上下坡。纜車連接伊達邵與九族文化村,空中視角能看見完整的湖形。清晨的霧與傍晚的光是兩個最好的時段,住一晚會比當天來回從容許多。',
    points: [
  ...
  hehuanshan: {
    ...
    intro:
      '合歡山之所以特別,在於台十四甲線可以直接開到武嶺——海拔 3,275 公尺,是台灣公路的最高點。這讓一般人不必長途跋涉就能站上高山,看見雲海與箭竹坡。主峰、東峰、石門山三條步道都在一小時內可完成。五、六月玉山杜鵑盛開,冬季寒流來時則可能積雪,也是台灣少數能看到雪的地方。從清境上武嶺約一小時車程,冬季寒流來時可能實施雪鏈管制,出發前要查路況。海拔高、氣溫低,即使夏天清晨也可能接近零度,保暖與防風外套不能省。上升太快容易有高山反應,前一晚住在清境適應會好很多。這裡也是台灣第一座國際暗空公園,夜裡的星空是另一個理由。',
    points: [
  ...
  cingjing: {
    ...
    intro:
      '清境農場位在海拔約一千七百公尺的緩坡上,夏季均溫二十度左右,是避暑的熱門去處。青青草原的綿羊放牧與剪羊毛秀是招牌節目,高空觀景步道則沿著山稜架設,可一路俯瞰群山與雲海。因為位置在通往合歡山的路上,多數人會把兩個景點排在同一趟行程裡,住一晚清境、隔天清晨上武嶺看日出。從台中出發車程約兩個半小時,山路蜿蜒,容易暈車的人要有準備。綿羊秀與馬術秀一天各兩場,時間固定,建議依場次安排動線。園區沿山坡分布,步行起伏不小,鞋子選舒適一點的。附近的小瑞士花園、與通往合歡山的台十四甲線,是最常見的兩種延伸走法。',
    points: [
  ...
  gaomei: {
    ...
    intro:
      '高美濕地是大甲溪出海口淤積形成的潮間帶,面積約三百公頃,擁有雲林莞草、招潮蟹與多種水鳥。它出名的原因在於退潮時薄薄一層水覆蓋在泥灘上,把天空與風車完整倒映出來,傍晚逆光時像一面巨大的鏡子。木棧道延伸進濕地約七百公尺,是唯一開放行走的區域,漲潮前會依規定管制關閉。從台中市區開車約五十分鐘,假日下午車潮明顯,停車場常滿。木棧道是否開放完全看潮汐,出發前務必查當日潮汐表,退潮前後兩小時才走得到最漂亮的鏡面。這裡風大且無遮蔽,夏天防曬、冬天防風都要做足。濕地是生態保護區,不可踩踏灘地或捕捉生物。',
    points: [
  ...
  anping: {
    ...
    intro:
      '安平是荷蘭人一六二四年登陸建城的地方,也是台灣最早發展的市街。安平古堡的前身熱蘭遮城、億載金城的砲台、以及被榕樹氣根整個包覆的安平樹屋,把不同時期的歷史層層疊在同一區。延平街是台灣第一條商業街,如今兩側是蜜餞、蝦餅與豆花老鋪,邊走邊吃是最自然的逛法。從台南車站搭公車約三十分鐘,或騎共享機車更方便;老街周邊停車格少,假日尤其難找。街區範圍不大,古堡、樹屋、老街可以步行串成半天行程。蚵仔煎、蝦捲與豆花是這一帶的招牌,建議少量多攤。傍晚往安平漁光島走,能看見不同於老街的安靜海灘。',
    points: [
  ...
  'chimei-museum': {
    ...
    intro:
      '奇美博物館由奇美實業創辦人許文龍創立,二〇一五年遷入台南都會公園內的新館。白色古典建築、阿波羅噴泉與奧林帕斯橋構成的入口軸線,本身就是台南最上鏡的場景之一。館藏以西洋藝術、樂器、兵器與自然史為主,其中小提琴收藏量居世界前列,包含多把史特拉底瓦里名琴。採線上預約制,現場不一定買得到票,務必提前訂。週三休館,安排行程時要留意。館外的都會公園腹地很大,建議預留時間在噴泉與橋上散步,傍晚的光線最適合拍白色建築。館內部分區域可拍照但禁用閃光燈,樂器廳每天有定時的演奏示範。',
    points: [
  ...
  'lotus-pond': {
    ...
    intro:
      '蓮池潭是高雄左營的人工湖,清代因湖中遍植蓮花而得名。環湖聚集了龍虎塔、春秋閣、五里亭等大量廟宇建築,色彩鮮豔、造型繁複,構成南台灣獨特的宗教景觀。龍虎塔的傳統是從龍口進、虎口出,取「化凶為吉」之意。環湖步道與自行車道約五公里,傍晚時分是當地人散步的路線。搭台鐵到左營舊城站或高鐵左營站,步行與轉乘都在十分鐘內。龍虎塔曾因整修長期封閉,前往之前建議先確認開放狀況。這一帶遮蔭少,夏日午後相當炎熱,清晨與傍晚是比較舒服的時段。周邊的蓮池潭夜市與左營舊城牆,可以順著一起走。',
    points: [
  ...
  'pier-2': {
    ...
    intro:
      '駁二原是高雄港的閒置倉庫群,二〇〇六年起陸續改造成藝文空間,如今分為大勇、蓬萊、大義三個區塊,涵蓋展覽館、獨立書店、餐飲與設計選物店。戶外散布著大型公共藝術,鐵道倉庫與輕軌穿過園區,構成工業感的背景。傍晚走到最外側的海邊,可以看見貨櫃碼頭與夕陽,是高雄港最直接的一面。搭輕軌駁二大義站或捷運鹽埕埔站都可直達,三個區塊之間步行約十分鐘。展覽多為期間限定且需另外購票,出發前先查當期檔期。假日常有市集與街頭表演,氣氛最熱鬧。往西走可以接哈瑪星與西子灣,搭渡輪到旗津吃海鮮、看夕陽,是高雄最經典的一條下午路線。',
    points: [
  ...
  baishawan: {
    ...
    intro:
      '白沙灣位在恆春半島西側,長約五百公尺。這裡的沙是由貝殼與珊瑚碎屑磨成的,顆粒細白、踩起來不燙腳,和一般的石英砂海灘明顯不同。因為位置背風、坡度平緩,水質清澈度是墾丁一帶最好的,浮潛與水上活動都集中在此。《少年 Pi 的奇幻漂流》曾在這片沙灘取景。從恆春市區開車約二十分鐘,沿途就是海岸線。沙灘上有付費的沖洗與寄物設施,水上活動多由店家承租,價格建議先問清楚。這裡沒有太多遮蔽,遮陽傘與防曬是必需品。夏季午後常有雷陣雨,下水前留意海邊的旗幟與廣播。',
    points: [
  ...
  eluanbi: {
    ...
    intro:
      '鵝鑾鼻燈塔建於一八八三年,是台灣唯一的武裝燈塔——當年為防範原住民與海盜,塔身設有槍眼與壕溝,至今仍能看見遺跡。它的光照射距離超過二十海里,被稱為「東亞之光」。園區內有珊瑚礁隆起形成的步道與奇岩,走到最外圈可以看見巴士海峽與太平洋在此交會。從恆春市區開車約三十分鐘,是墾丁最南端的景點之一。園區需購票入園,燈塔本身不開放登塔,但周邊步道與草坪腹地很大。正午幾乎沒有遮蔭,清晨或接近閉園時最舒服。往旁邊走幾分鐘就是台灣最南點,再過去的龍坑生態保護區則需要事先線上申請。',
    points: [
  ...
  longpan: {
    ...
    intro:
      '龍磐是隆起的珊瑚礁台地,因為長年受落山風吹襲,樹木難以生長,只留下大片低矮草原。草坡一路延伸到崖邊,下方就是垂直落入太平洋的斷崖,視野毫無遮擋。這裡沒有路燈與建築,光害極低,是墾丁最好的觀星地點,夏季晴朗的夜晚可以清楚看見銀河。從恆春開車約三十分鐘,沿著佳鵝公路一路往東就能看到。崖邊沒有護欄,草長且地形起伏,靠近時務必留意腳下與強風。這裡沒有路燈,夜間前往建議結伴並自備手電筒。農曆月初前後月光最弱,是看銀河最好的時機;冬季落山風強到站不太穩,要有心理準備。',
    points: [
  ...
  xiaoliuqiu: {
    ...
    intro:
      '小琉球是台灣唯一由珊瑚礁構成的離島,面積約六・八平方公里,環島公路僅十二公里,租機車一小時就能繞完。它最出名的是綠蠵龜——因為周邊海草豐富,海龜密度極高,即使只是在美人洞或蛤板灣附近浮潛,遇見的機率也相當大。島上還有花瓶岩、烏鬼洞等珊瑚礁侵蝕地形。從東港搭船約三十分鐘,班次密集,當天來回可行但會很趕。島上機車是主要交通工具,持駕照才能租借。與海龜共游時規定保持三公尺以上距離,不可觸摸或追逐,也禁止使用含特定化學成分的防曬。夏季假日住宿需要提前預訂,旺季常一房難求。',
    points: [
  ...
  'double-heart': {
    ...
    intro:
      '石滬是澎湖傳統的捕魚設施——在潮間帶用玄武岩與珊瑚礁堆砌成弧形石牆,漲潮時魚群隨海水進入,退潮後就被困在滬內。七美這座石滬因為兩個集魚區恰好形成雙心形狀而聞名,已有超過七百年歷史。它是目前保存最完整、也是澎湖最上鏡的一座,退潮時整個心形輪廓會完整浮出水面。位在七美嶼東北角,從馬公搭船或飛機到七美後,再租機車約十五分鐘。心形是否完整浮現完全取決於潮汐,出發前務必查退潮時間,漲潮時只看得到模糊的輪廓。觀景台位在高處,拍攝時用廣角比較容易把兩個心一起收進畫面。強風時崖邊要特別小心。',
    points: [
  ...
  qimei: {
    ...
    intro:
      '七美是澎湖群島最南端的島嶼,名字來自明代七位女子投井殉節的傳說。全島以玄武岩台地為主,四周被海蝕崖環繞,環島公路約十四公里,租機車一個多小時就能繞完。除了雙心石滬,還有小台灣、望夫石、龍埕等因海蝕形成的特殊地貌,幾乎每個轉彎都能停下來看海。從馬公南海遊客中心搭船約一小時,也有小飛機航線;冬季風浪大,船班取消是常態。多數人以一日遊方式前往,但船班時間固定,環島節奏會比較趕,想慢慢看建議在島上住一晚。租機車前先確認電量與油量,島上加油站與店家數量都不多。',
    points: [
  ...
  jibei: {
    ...
    intro:
      '吉貝沙尾是由貝殼砂與珊瑚碎屑堆積形成的沙嘴,長達七百多公尺,像一條白色的舌頭伸進海中。因為兩側水深不同,海水會呈現深淺不一的藍綠色,是澎湖最具代表性的畫面之一。這裡也是水上活動最密集的地方,香蕉船、水上摩托車與浮潛都能一次滿足。沙嘴的形狀會隨季節與風向緩慢改變。從赤崁碼頭搭船約二十分鐘,夏季班次密集,冬季則大幅減少甚至停駛。沙嘴前端水流較強,標示範圍外不宜下水。水上活動多以套裝方式販售,先問清楚包含哪些項目與保險。這裡幾乎沒有遮蔽,防曬與飲水要自己準備充足。',
    points: [
  ...
  'penghu-bridge': {
    ...
    intro:
      '澎湖跨海大橋橫跨吼門水道,連接白沙島與西嶼,一九七〇年通車時是遠東最長的跨海大橋。這道水道的海流極為湍急,建橋前兩島往來只能靠船,遇上風浪就得中斷。現在的橋體是一九九六年改建後的版本,橋頭的白色拱門是最經典的合影位置,傍晚時分逆光的剪影特別漂亮。從馬公開車約三十分鐘,是前往西嶼的必經之路。橋上禁止停車,想拍照要停在兩端的停車場再走過去。順路可以接上通樑古榕,以及西嶼的二崁聚落與大菓葉柱狀玄武岩,排成半天到一天的西嶼線行程。傍晚逆光最漂亮,但風也最強,帽子要拿好。',
    points: [
